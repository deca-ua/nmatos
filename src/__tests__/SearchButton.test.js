...
describe('SearchButton', () => {
  it('renders with the correct text when not loading', () => {
    ...
    render(<SearchButton onClick={mockOnClick} loading={false} disabled={false} />);
  ...
  it('renders with the correct text when loading', () => {
    const mockOnClick = jest.fn();
    render(<SearchButton onClick={mockOnClick} loading={true} disabled={false} />);
  ...
  it('is disabled when disabled prop is true', () => {
    const mockOnClick = jest.fn();
    render(<SearchButton onClick={mockOnClick} loading={false} disabled={true} />);
